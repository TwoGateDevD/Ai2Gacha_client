    ...
    >
      ...
      <chakra.div display="flex" flexDirection="column" marginLeft="1.25rem" justifyContent="space-between">
        ...
        <chakra.div display="flex" alignItems="flex-end" justifyContent="space-between">
          {(!isPossession && !isExhibit ) && <chakra.p fontSize="0.875rem" color="black">{`残り ${remaining}個`}</chakra.p>}
          {/* eslint-disable-next-line jsx-a11y/anchor-is-valid */}
          <Link href={link} passHref>
            <Button as="a" isNegative={isExhibit} border={false} disable={false} paddingX="1.25rem" paddingY="0.125rem" fontSize="1.25rem">
              {isExhibit ? "出品中" : "選択"}
            </Button>
          </Link>
